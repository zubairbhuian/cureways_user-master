...
class TodayAddedWeightList extends StatelessWidget {
  const TodayAddedWeightList({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<GetWeightListController>(builder: (controller) {
            ...
            children: [
              ...
              ...List.generate(controller.filteredList.length, (index) {
                return TableRow(children: [
                  ...
                  Padding(
                    padding: const EdgeInsets.all(12),
                    child: Text(controller.filteredList[index].weight ?? ""),
                  )
                ]);
              })
            ]),
