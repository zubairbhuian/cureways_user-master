class AddHealthProfileResponseModel {
  AddHealthProfileResponseModel({
    this.data,
    this.message,
    this.status,
  });

  AddHealthProfileResponseModel.fromJson(dynamic json) {
    data = json['data'] != null
        ? AddHealthProfileData.fromJson(json['data'])
        : null;
    message = json['message'];
    status = json['status'];
  }
  AddHealthProfileData? data;
  String? message;
  int? status;
...
class AddHealthProfileData {
  ...
  AddHealthProfileData.fromJson(dynamic json) {
    id = json['id'];
    userId = json['user_id'];
    age = json['age'];
    gender = json['gender'];
